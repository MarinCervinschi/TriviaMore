...
const TYPES = ["MULTIPLE_CHOICE", "TRUE_FALSE", "SHORT_ANSWER"] as const
const DIFFICULTIES = ["EASY", "MEDIUM", "HARD"] as const

type QType = (typeof TYPES)[number]
type QDiff = (typeof DIFFICULTIES)[number]
...
function parseAnswers(md: string): Map<number, ParsedAnswer> {
