...
import { getCourseWithClasses, searchCourses } from "../../src/lib/browse/service/courses.ts"
import {
...
if (attempt) {
  await check("quiz.getQuizResults", () =>
    getQuizResults(attempt.user_id, attempt.id),
  )
} else {
