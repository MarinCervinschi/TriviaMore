			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="mb-8 rounded-2xl border border-gray-100 bg-white p-8 shadow-lg dark:border-gray-700 dark:bg-gray-800">
					<div className="text-center">
						...
						<p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300">
							Scopri tutti i dipartimenti e i corsi disponibili. Naviga attraverso la
							struttura accademica per trovare i contenuti che ti interessano.
						</p>
					</div>
				</div>
				...
				<div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
					{departments?.map(department => (
						<Link
							key={department.id}
							href={`/browse/${department.code.toLowerCase()}`}
