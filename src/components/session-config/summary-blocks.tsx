...
export function MetricBlock({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      {hint && (
        <div className="text-[10.5px] text-muted-foreground/80">{hint}</div>
      )}
    </div>
  )
}
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-baseline gap-1.5">
          <div className="text-[24px] font-bold leading-none tabular-nums text-foreground">
            {isUnlimited ? "∞" : minutes}
          </div>
          {!isUnlimited && (
  ...
  return (
    <div className="flex items-center gap-4">
      <div className="relative h-[120px] w-[96px]">
        <div className="absolute inset-0 rotate-[-8deg] rounded-xl border border-border bg-muted" />
        <div className="absolute inset-0 rotate-[-3deg] rounded-xl border border-border bg-muted/80" />
        <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-gradient-to-br from-[#fb6f3d] to-primary text-white shadow-md">
