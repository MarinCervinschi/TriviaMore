	...
	return (
		<div className="space-y-4">
			...
			<div className="rounded-xl border border-dashed p-6 text-center">
				{file ? (
					...
					<div className="space-y-2">
						...
						<p className="text-muted-foreground/70 text-xs">PDF o DOCX, max 10 MB</p>
						<Button
							variant="outline"
							size="sm"
			...
			<p className="text-muted-foreground text-xs">
				Carica un file contenente domande gia pronte. Limitati a file con domande
				strutturate per facilitare la revisione.
			</p>
