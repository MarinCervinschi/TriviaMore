	...
	return (
		<section aria-label="Altri documenti legali" className="mt-12 space-y-4">
			...
			<div className="grid gap-4 sm:grid-cols-2">
				{others.map(doc => (
					<Link key={doc.slug} to={doc.href} className="group block">
						<InsetCard className="hover:border-primary/40 hover:shadow-primary/5 h-full transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg">
