...
function BenefitItemComponent({
	...
	return (
		<div className="flex gap-4">
			<div className="bg-primary/10 text-brand flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm font-bold">
				{index + 1}
			</div>
			<div>
...
function CTACard({
	...
	return (
		<motion.div
			ref={ref}
			className="border-primary/20 from-primary/5 via-card to-card relative overflow-hidden rounded-3xl border bg-gradient-to-br p-8 sm:p-10"
			variants={fadeUp}
			initial="hidden"
		...
		<section className="relative py-20 sm:py-28">
			<div className="container">
				...
				<div className="mb-20 grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
					...
					>
						<p className="text-brand eyebrow-lg mb-3">Perché TriviaMore</p>
