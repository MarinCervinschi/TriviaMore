...
export function SupabaseIcon({ className, size = 24 }: TechIconProps) {
	return (
		<svg viewBox="0 0 109 113" width={size} height={size} className={className}>
			<path
...
export function TanStackIcon({ className, size = 24 }: TechIconProps) {
	return (
		<svg viewBox="0 0 633 633" width={size} height={size} className={className}>
			<path
				fill="#002B41"
...
export function ViteIcon({ className, size = 24 }: TechIconProps) {
	const id = useId().replace(/:/g, "");
	return (
		<svg viewBox="0 0 256 257" width={size} height={size} className={className}>
			<defs>
				<linearGradient
					id={`${id}-a`}
					x1="-.828%"
...
export function DrizzleIcon({ className, size = 24 }: TechIconProps) {
	return (
		<svg
			viewBox="0 0 160 160"
			width={size}
			height={size}
			className={cn("text-[#C5F74F]", className)}
		>
			{[
				[43.4805, 67.5215],
				[76.9629, 46.5605],
				...
				<rect
					...
					rx="4.8157"
					fill="currentColor"
					transform={`matrix(0.873028 0.48767 -0.497212 0.867629 ${x} ${y})`}
				/>
			))}
		</svg>
	);
...
export const techStackItems = [
	...
	{ name: "Drizzle ORM", Icon: DrizzleIcon, color: "#C5F74F" },
